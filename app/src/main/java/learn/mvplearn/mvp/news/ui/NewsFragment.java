...
//        adapter.addFragment(NewsListFragment.newInstance(NEWS_TYPE_GAME), getString(R.string.game));
     ...
     //   adapter.addFragment(new testFragment(), getString(R.string.funy));
        adapter.addFragment(new testFragment(), getString(R.string.girl));
        adapter.addFragment(new testFragment(), getString(R.string.movie));
        adapter.addFragment(new testFragment(), getString(R.string.game));
